> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [nil.csail.mit.edu](http://nil.csail.mit.edu/6.824/2020/labs/lab-mr.html)
...
Use the make lab1 command to package your lab assignment and upload it to the class's submission website, located at [https://6824.scripts.mit.edu/2020/handin.py/](https://6824.scripts.mit.edu/2020/handin.py/).
